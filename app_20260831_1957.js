...
function aiHubQueryAll(root, selector) {
    ...
    if (!root || typeof root.querySelectorAll !== "function") {
        console.debug("[aiHub] EMPTY return for selector=" + String(selector) + " rootType=" + (root ? typeof root : "null"));
        return [];
    }
    ...
    console.debug("[aiHub] selector=" + String(selector) + " count=" + result.length + " type=" + ({}).toString.call(result) + " forEach=" + typeof result.forEach + " elapsed=" + elapsed.toFixed(2) + "ms");
    return result;
}
...
const APP_VERSION = "20260831_1957";
