...
const APP_VERSION = "20260905_1906";
...
function aiHubQueryAll(root, selector) {
    ...
    try {
        ...
        console.debug("[aiHubQueryAll] selector=" + selector + " count=" + out.length + " type=" + typeof out + " hasForEach=" + (typeof out.forEach === "function"));
        return out;
    } catch (e) {
        console.debug("[aiHubQueryAll] error for selector=" + selector + " error=" + e.message);
        return [];
    }
}
...
console.log("[app] script start v20260905_1845");
...
const _q3 = aiHubQueryAll(document, "[data-close]"); if (_q3 && typeof _q3.forEach === "function") _q3.forEach((btn) => {
    btn.addEventListener("click", () => {
...
function showBetaWelcome() {
    return new Promise((resolve) => {
        ...
        const cleanup = () => {
            ...
            const _q = aiHubQueryAll(document, "[data-close]"); if (_q && typeof _q.forEach === "function") _q.forEach((b) => b.removeEventListener("click", onClose));
            resolve();
        };
        ...
        const _q2 = aiHubQueryAll(document, "[data-close]"); if (_q2 && typeof _q2.forEach === "function") _q2.forEach((b) => b.addEventListener("click", onClose));
        modal.classList.add("open");
    });
}
