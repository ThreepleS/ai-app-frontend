...
const APP_VERSION = "20260907_0616";
...
function sanitizeMdHtml(htmlStr) {
    ...
    return DOMPurify.sanitize(htmlStr, {
        ...
        ALLOWED_ATTR: ["href", "src", "alt", "class", "open"],
    ...
    try {
        ...
        html = html.replace(
            ...
            (_, i) => {
                ...
                return `<details class="thinking-block"><summary class="thinking-summary"><span class="thinking-title"><span class="thinking-icon">🧠</span> Размышления</span><span class="thinking-arrow">▼</span></summary><div class="thinking-content">${thinkBody}</div></details>`;
            }
        );
        return html;
    } catch (_) {
        ...
        <details class="error-details">
            <summary class="error-summary">
                <span class="error-summary-title">
                    <span>⚙️</span> Развернуть технические детали ошибки
                </span>
    ...
    return `
        <div class="chat-error-card">
            ...
            <div class="chat-error-actions">
                <button type="button" class="chat-error-btn select-model-btn" onclick="try{mbOpen()}catch(_){}">
                    <span>🔄</span> Выбрать другую модель
                </button>
            </div>
            ${rawBlock}
        </div>
...
function addErrorMessage(title, friendlyMsg, rawDetails) {
    ...
    return addMessage("bot error-msg", html);
}
        ...
        const flushLine = async (line) => {
            ...
            if (ev.type === "start") {
                ...
                if (!thinkingEl) {
                    ...
                    thinkingEl.innerHTML = `<summary class="thinking-summary"><span class="thinking-title"><span class="thinking-icon">🧠</span> Размышления <span class="thinking-badge"><span class="thinking-pulse"></span> рассуждает...</span></span><span class="thinking-arrow">▼</span></summary><div class="thinking-content"></div>`;
