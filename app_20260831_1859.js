...
// объект с гарантированным .forEach, .length и .indexOf. ===
function aiHubQueryAll(root, selector) {
    if (!root || typeof root.querySelectorAll !== "function") {
        return makeQsaResult([]);
    }
    ...
    return makeQsaResult(result);
}
function makeQsaResult(arr) {
    var obj = {
        length: arr.length,
...
// Make aiHubQueryAll non-configurable, non-writable global to prevent shadowing
try {
...
const APP_VERSION = "20260831_1859";
